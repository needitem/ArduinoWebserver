#line 1 "C:\\Users\\th072\\OneDrive\\바탕 화면\\수업내용\\iot\\motor\\motor.h"
#pragma once

#include <Servo.h>

#define DEF_SERVO_PORT	(8)
...
public: // public member(외부 접근 가능)
	motor(void) { setPort(DEF_SERVO_PORT); } // 생성자(클래스가 생성될 때 호출되는 함수)
	~motor() {} // 파괴자(클래스가 파괴될 때 호출되는 함수)
